# Complexity Driven Development (CDD) Methodology Framework
...
## 2. Core Philosophy
The shift from traditional development to CDD requires a fundamental change in perspective:
...
To support CDD, development teams produce specific artifacts:
...
Success in CDD is not measured merely by velocity or defect rate, but by systemic viability:
