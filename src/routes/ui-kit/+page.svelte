...
<div class="p-6">
  <h1 class="text-2xl font-bold text-gray-900 mb-1">UI Kit</h1>
  <p class="text-sm text-gray-500 mb-6">Full-page scenario views replicating real Nondominium screens.</p>
...
<style>
  .scenario-grid { display: grid; gap: 1rem; grid-template-columns: repeat(auto-fill, minmax(16rem, 1fr)); }
  .scenario-card {
  ...
  .scenario-card:hover { box-shadow: var(--ndo-shadow-md); }
  .scenario-label { font-size: 0.9375rem; font-weight: 600; color: rgb(var(--ndo-gray-900)); }
  .scenario-desc { margin: 0.25rem 0 0; font-size: 0.8125rem; color: rgb(var(--ndo-gray-600)); line-height: 1.4; }
</style>
