...
If you are creating visual artifacts (slides, mocks, throwaway prototypes), lift the class strings from `/playbook` — they are the app's own — or use `static/tokens.css` when the output cannot run UnoCSS.
